<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Disponibilidad.aspx.cs" Inherits="SistemaTurismoReal.Disponibilidad" %>
    ...
    <div class="container" >
        ...
        <div class="row">
            ...
            <div class="row" >
                ...
                <asp:GridView ID="GridDepartamentos" runat="server" DataKeyNames="ID" CssClass="gridview" BackColor="#0B5345" BorderStyle="None" BorderWidth="1px" CellPadding="8" CellSpacing="9" OnSelectedIndexChanged="GridDepartamentos_SelectedIndexChanged" >
                    <AlternatingRowStyle Wrap="False" />
                    <HeaderStyle BackColor="#117A65" CssClass="Gridheader" HorizontalAlign="Center" Font-Size="Smaller" ForeColor="White" Font-Bold="False" />
